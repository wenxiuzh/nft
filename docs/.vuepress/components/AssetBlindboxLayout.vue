        ...
        <vs-col type="flex" vs-justify="center" vs-align="center" vs-w="5">
          <div style="padding:1rem;">
            ...
            <div class="recommand-desc-bottom">
              ...
              <vs-button @click="popupActivo=true" class="recommand-desc-button"  color="danger" type="gradient" style="width:100%;height:3rem;position:relative;bottom:0px;">立即购买</vs-button>
    ...
    <div class="contenedor">
      ...
      <box>
        <vs-row vs-justify="flex-start" class="recommand-desc-card-blind-box">
          <vs-col v-for="col,index in blindboxSetting" type="flex" vs-justify="center" vs-align="center" vs-w="4">
            <div style="padding:10px;">
              <vs-card class="blindbox-card">
                <div>
                  <span style="padding-left:20px;font-size:14px;">{{col.productName}}</span>
                  <a style="float:right;padding-right:10px;">{{col.percentage}}%概率</a>
                </div>
              </vs-card>
            </div>
          </vs-col>
...
export default {
  ...
  methods:{
    getAnnouncements(id){
        this.axios({
            method: 'get',
            url: '/api/pub/bboxProd/findBlindboxProduct?ID='+id,
          headers: {
        ...
        // var json = api
          ...
          this.asset = json.data.data.rebboxProd;
          this.blindboxSetting = JSON.parse(this.asset.blindboxSetting);
