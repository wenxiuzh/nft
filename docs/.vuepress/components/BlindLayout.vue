  ...
  <div>
    <div class="content content-pagex">
      <vs-row>
        ...
        <vs-col :key="index" v-for="col,index in blindboxAssets" vs-type="flex" vs-justify="center" vs-align="center" vs-w="4">
          ...
          <vs-card>
            ...
            <div slot="footer">
              <vs-row vs-justify="flex-end">
                <vs-button color="primary" type="gradient" :href="{url: '/asset-blindbox/?a='+col.ID }" >查看</vs-button>
              </vs-row>
            </div>
          </vs-card>
          </div>
...
export default {
  ...
  methods:{
    getPreviewAssets(currentPage){
        this.axios({
            method: 'get',
            url: '/api/pub/bboxProd/getBlindboxProductList?page='+currentPage+'&pageSize=12',
          headers: {
        ...
        // var json = api
          ...
          this.blindboxAssets = currentAssets;
