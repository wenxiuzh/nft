...
export function resolveSidebarItems (page, route, site, localePath) {
  ...
  if(route.path == '/my/' || route.path == '/my/info/' || route.path == '/my/assets/' || route.path == '/my/bought/' || route.path == '/my/settings/' || route.path == '/my/sold/' || route.path == '/my/trade/' || route.path == '/my/withdraw/'){
    sidebarConfig = localeConfig.my || themeConfig.my
  }
  if(route.path === '/announcement/'){
    sidebarConfig = localeConfig.announcement || themeConfig.announcement
  }
  if(route.path === '/help/'){
    sidebarConfig = localeConfig.help || themeConfig.help
  }
